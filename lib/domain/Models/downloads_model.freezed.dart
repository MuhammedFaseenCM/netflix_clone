...
mixin _$Downloads {
  ...
  String? get postePath => throw _privateConstructorUsedError;
...
abstract class $DownloadsCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: "poster_path") String? postePath});
}
...
class _$DownloadsCopyWithImpl<$Res, $Val extends Downloads>
  ...
  @override
  $Res call({
    Object? postePath = freezed,
  }) {
    return _then(_value.copyWith(
      postePath: freezed == postePath
          ? _value.postePath
          : postePath // ignore: cast_nullable_to_non_nullable
              as String?,
    ) as $Val);
  }
}
...
class _$_Downloads implements _Downloads {
  const _$_Downloads({@JsonKey(name: "poster_path") required this.postePath});
  ...
  @override
  String toString() {
    return 'Downloads(postePath: $postePath)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.postePath, postePath) ||
                other.postePath == postePath));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, postePath);
...
abstract class _Downloads implements Downloads {
  const factory _Downloads(
          {@JsonKey(name: "poster_path") required final String? postePath}) =
      _$_Downloads;
